...
class MaterialFactoryTestNew {
    ...
    void testCreatePrintedBook() {
        ...
        properties.put("id", "9781234567890");
    ...
    void testCreateEBook() {
        ...
        properties.put("year", 2023);
        properties.put("format", "PDF");
        properties.put("fileSize", 5.5);
        properties.put("downloadable", true);
        properties.put("pages", 250);
    ...
    void testCreateEBookAlternativeType() {
        ...
        properties.put("year", 2023);
        properties.put("format", "EPUB");
        properties.put("fileSize", 3.0);
        properties.put("downloadable", false);
        properties.put("pages", 200);
        properties.put("quality", Media.MediaQuality.STANDARD);
        
        Material material = MaterialFactory.createMaterial("E-BOOK", properties);
    ...
    void testCreateWithPartialProperties() {
        ...
        properties.put("price", 19.99);
        properties.put("year", 2023);
        // Missing pages, publisher, hardcover - should use defaults
    ...
    void testCreateMultipleMaterials() {
        ...
        bookProps.put("id", "9781234567890");
        ...
        ebookProps.put("format", "PDF");
        ebookProps.put("fileSize", 5.5);
        ebookProps.put("downloadable", true);
        ebookProps.put("pages", 250);
