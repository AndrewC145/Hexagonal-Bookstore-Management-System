# Bookstore Management System - Lab 3
...
[![Coverage](https://img.shields.io/badge/Coverage-38%25-yellow.svg)](target/site/jacoco/index.html)
...
### 10. Resources Package (`src/main/resources`)
...
### 11. Testing Infrastructure (`src/test/java`)
...
- **Purpose**: End-to-end quality validation for all Lab 3 functionality
- **Key Features**: 
...
- **Total Source Files**: 66 Java classes
...
- **Test Coverage**: 38% (6,808 of 17,849 instructions)
...
#### **Required Software**
- **Java 21** or higher (JDK recommended for development)
...
By completing Lab 3, students will:
...
- **Lab Assignment**: Bookstore Management System - Lab 3
- **Academic Year**: 2025
